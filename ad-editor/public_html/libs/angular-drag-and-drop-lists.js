...
angular.module('dndLists', [])
    ...
    .directive('dndDraggable', ['$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround',
        ...
        return function(scope, element, attr) {
            ...
            element.on('dragstart', function(event) {
                ...
                var component = scope.$eval(attr.dndDraggable);
     ...
     */
    .directive('dndList', ['$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround', 'componentsService', 'ruleCheckerService',
                   function($timeout,   dndDropEffectWorkaround,   dndDragTypeWorkaround, componentsService, ruleCheckerService) {
        return function(scope, element, attr) {
            ...
            element.on('dragover', function(event) {
                ...
                /////////////////////////////////////////////
                //Adjustment for the project
                // check if rules evaluate to true
                var placeholderIndex = Array.prototype.indexOf.call(listNode.children, placeholderNode);
//                console.log("ruleCheckerDragnDrop " + placeholderIndex);
                if (!ruleCheckerService.checkManipulationOfComponentsListWithComponentSearch(placeholderIndex)) return true;
                /////////////////////////////////////////////
            ...
            element.on('drop', function(event) {
                ...
                scope.$apply(function() {
                    /////////////////////////////////////////////
                    //Adjustment for the project
                    componentsService.changeOrderBy("currentOrder", transferredObject, placeholderIndex);
                    /////////////////////////////////////////////
